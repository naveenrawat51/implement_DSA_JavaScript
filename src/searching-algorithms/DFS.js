...
console.log('preOrder: ', bst1.depthFirstSearchPreOrder());
console.log('inOrder: ', bst1.depthFirstSearchInOrder());
console.log('PostOrder: ', bst1.depthFirstSearchPostOrder());
